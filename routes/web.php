...
Route::middleware('auth')->group(function () {
    ...
    Route::post("/dashboard/show-event",[\App\Http\Controllers\dashEvent::class,"deleteEvent"])->name("deleteEvent");
...
//Product
    ...
    Route::post("/dashboard/show-product",[\App\Http\Controllers\dashProduct::class,"deleteProduct"])->name("deleteProduct");
